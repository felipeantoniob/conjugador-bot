...
func fetchVerbFromDB(infinitive string, tenseMoodObject models.TenseMood) (*models.Verb, error) {
...
func createConjugationEmbed(infinitive string, verb *models.Verb) *discordgo.MessageEmbed {
	return &discordgo.MessageEmbed{
		...
		Fields: []*discordgo.MessageEmbedField{
			...
			{Name: "yo", Value: verb.Form1s, Inline: true},
			{Name: "tú", Value: verb.Form2s, Inline: true},
			{Name: "él/ella/Ud.", Value: verb.Form3s, Inline: true},
			{Name: "nosotros", Value: verb.Form1p, Inline: true},
			{Name: "vosotros", Value: verb.Form2p, Inline: true},
			{Name: "ellos/ellas/Uds.", Value: verb.Form3p, Inline: true},
		},
	}
}
